...
import menus.*;
    ...
    import source._nA_._ax;
    import flash.display.Shape;
    import com.company.assembleegameclient.game_.ui._0K_B_;
    ...
    import com.company.assembleegameclient.game_.charrects.CharacterRect;
    import com.company.googleanalytics.GA;
    import source._0L_C_._4B_;
    import source._qN_.Account;
    import source._0L_C_._qO_;
    import source._0D_d._T_K_;
    ...
    public class CurrentCharacterScreen extends _05p {
        ...
        private var _p6:Buttons;
        private var _0G_N_:Buttons;
        private var _dL_:Shape;
        private var _E_k:_0K_B_;

        public function CurrentCharacterScreen(){
            addChild(new _R_f());
            this._qR_ = new Buttons("play", 36, true);
            this._p6 = new Buttons("main", 22, false);
            this._0G_N_ = new Buttons("classes", 22, false);
