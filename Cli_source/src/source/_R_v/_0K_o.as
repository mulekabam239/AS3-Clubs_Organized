...
package source._R_v{
    ...
    import com.company.assembleegameclient.game_.ui.common.Icons;
    ...
    import com.company.assembleegameclient.game_.ui._7f;
    import com.company.assembleegameclient.game_.game.GameSprite;
    import source._qN_.Account;
    import com.company.assembleegameclient.game_.ui.common.FrameHolder;
    import source._0D_d._8x;
    import source._0L_C_._2k;
    ...
    public class _0K_o extends Panel {
        ...
        public function _0K_o(_arg1:GameSprite, _arg2:int){
            ...
            if (this._B_E_)
            {
                ...
                this._O_k.y = 0;
                addChild(this._O_k);
                _local5 = new Icons("Change ", 16, Parameters._0u, Currency._class);
            ...
            } else
            {
                if (_local3.numStars_ < _arg2)
                {
                    ...
                    _local8 = new Rank(_arg2, false, false);
