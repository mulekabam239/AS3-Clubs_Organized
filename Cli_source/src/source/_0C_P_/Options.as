...
package source._0C_P_{
    ...
    public class Options extends Sprite {
        ...
        private var _0Q_:Buttons;
        private var _7z:Buttons;
        private var _pc:Buttons;
        ...
        public function Options(_arg1:GameSprite){
            ...
            this._0Q_ = new Buttons("continue", 36, false);
            this._0Q_.addEventListener(MouseEvent.CLICK, this._0B_Z_);
            addChild(this._0Q_);
            this._7z = new Buttons("reset to defaults", 22, false);
            this._7z.addEventListener(MouseEvent.CLICK, this._T_8);
            addChild(this._7z);
            this._pc = new Buttons("back to home", 22, false);
        ...
        private function _Y_V_():void{
            ...
            this._yZ_(new Sprite());
            this._yZ_(new _0I_j("playSFX", new <String>["On", "Off"], [true, false], "Play Sound Effects", "This toggles whether sounds effects are played", this._super));
            this._yZ_(new Sprite());
