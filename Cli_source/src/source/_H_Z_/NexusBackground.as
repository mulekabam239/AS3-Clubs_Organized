...
package source._H_Z_{
    ...
    public class NexusBackground extends Background {
        ...
        override public function draw(_arg1:MapView, _arg2:int):void{
        ...
        private function _0E_O_(_arg1:MapView, _arg2:int):void{
            var _local4:Island;
            var _local3:int;
...
import source._H_Z_.NexusBackground;
import com.company.assembleegameclient.game_.map.MapView;
...
class Island {
    ...
    public function draw(_arg1:MapView, _arg2:int, _arg3:Vector.<IGraphicsData>):void{
