...
//com.company.assembleegameclient.network.net.Connection

package com.company.assembleegameclient.network.net{
    ...
    import source._011._G_f;
    import source._011._T_n;
    import packets.Create;
    import packets.PlayerShoot;
    import packets.Move;
    import packets.PlayerText;
    import source._011.Text;
    import source._011._T_m;
    import source._011.Damage;
    import source._011.Update;
    import com.company.net._098;
    import source._011._01R_;
    import source._011._iD_;
    import source._011._0_l;
    import packets.InvSwap;
    import packets.UseItem;
    import source._011._06N_;
    import packets.others._0B_y;
    import source._011._04R_;
    import packets.InvDrop;
    import source._011._08K_;
    import source._011._8_;
    import source._011._0F_I_;
    import packets.others._kL_;
    import source._011._wx;
    import packets.Load;
    import source._011.Pic;
    import packets.SetCondition;
    import packets.Teleport;
    import packets.UsePotal;
    import source._011._00q;
    import packets.Buy;
    import source._011._08E_;
    import source._011._05F_;
    import packets.GroundDamage;
    import packets.PlayerHit;
    import packets.EnemyHit;
    import packets.others._bG_;
    import packets.others._0I_8;
    import packets.OtherHit;
    import packets.SquareHit;
    import packets.GotoAck;
    import packets.others._0C_7;
    import source._011._0K_U_;
    import source._011._Y_F_;
    import packets.ChooseName;
    import source._011._0D_q;
    import packets.CreateGuild;
    import source._011._ic;
    import packets.GuildRemove;
    import packets.GuildInvite;
    import source._011._I_o;
    import source._011._C_3;
    import packets.RequestTrade;
    import source._011._Y_G_;
    import source._011._S_M_;
    import packets.ChangeTrade;
    import source._011._Z_J_;
    import packets.AcceptTrade;
    import packets.CancelTrade;
    import source._011._A_L_;
    import source._011._qe;
    import source._011._0F_u;
    import packets.CheckCredits;
    import packets.Escape;
    import source._011.File;
    import source._011._039;
    import packets.JoinGuild;
    import packets.ChangeGuildRank;
    import source._011._bB_;
    ...
    import com.company.assembleegameclient.game_.objects.common.SellableObject;
    import com.company.assembleegameclient.network.util.Currency;
    ...
    import com.company.assembleegameclient.network.util._wW_;
    import source._R_v._L_k;
    import com.company.assembleegameclient.game_.objects.common.ObjectLibrary;
    import com.company.assembleegameclient.network.net.messages.data.ObjectStatusData;
    import com.company.assembleegameclient.network.net.messages.data._0H_9;
    import com.company.assembleegameclient.network.net.messages.data._iZ_;
    import source._015._O_P_;
    import source._0M_H_._sN_;
    import source._8Q_._1l;
    import source._0M_H_._W_O_;
    import source._0K_m._I_b;
    import flash.geom.Point;
    import source._0K_m._0H_T_;
    import source._0K_m.TeleportEffect;
    import source._0K_m.StreamEffect;
    import source._0K_m.ThrowEffect;
    import source._0K_m._Q_s;
    import source._0K_m._l2;
    import source._0K_m._0I_o;
    import source._0K_m._C_e;
    import source._0K_m.FlowEffect;
    import source._0K_m._040;
    import source._0K_m._9h;
    import source._0K_m._0S_;
    import source._0K_m._mn;
    import com.company.assembleegameclient.game_.objects._T_f;
    import flash.utils.getTimer;
    import source._yY_._pz;
    import com.company.assembleegameclient.network.net.messages.data.StatData;
    import com.company.assembleegameclient.game_.objects.common.Merchant;
    import com.company.assembleegameclient.game_.objects.common.Portal;
    import com.company.assembleegameclient.game_.objects.common.Container;
    import com.company.assembleegameclient.game_.objects.common.NameChanger;
    import source._015._6T_;
    import sounds._5T_;
    import source._9R_._j_;
    import com.company.assembleegameclient.game_.map._pf;
    import com.company.assembleegameclient.game_.ui._B_N_;
    import flash.display.BitmapData;
    import source._G_A_._8P_;
    import source._U_5._06a;
    import source._0L_C_._02d;
    import source._0L_C_._aZ_;
    import source._0K_m._pK_;
    import source._9R_._3E_;
    import source._9R_._J_F_;
    import flash.net.FileReference;
    import source._R_v._o0;
    import flash.events.TimerEvent;
    import source._0L_C_._qO_;
    import source._9R_._D_X_;

    import com.company.assembleegameclient.game_.objects.*;
    import source._0K_m.*;
    import source._011.*;
    import packets.*;
    import com.company.assembleegameclient.network.net.messages.data.*;
    ...
    public class Connection {
        ...
        public function Connection(_arg1:GameSprite, _arg2:Server, _arg3:int, _arg4:Boolean, _arg5:int, _arg6:int, _arg7:ByteArray, _arg8:String){
            this.gs_ = _arg1;
            this.server_ = _arg2;
            this.gameId_ = _arg3;
            this._96 = _arg4;
            ...
            this._08._g9(PLAYERSHOOT, PlayerShoot, null);
            this._08._g9(MOVE, Move, null);
            this._08._g9(PLAYERTEXT, PlayerText, null);
            ...
            this._08._g9(INVSWAP, InvSwap, null);
            this._08._g9(USEITEM, UseItem, null);
            this._08._g9(_0E_H_, _06N_, this._V_z);
            this._08._g9(HELLO, _0B_y, null);
            this._08._g9(GOTO, _04R_, this._gk);
            this._08._g9(INVDROP, InvDrop, null);
            ...
            this._08._g9(LOAD, Load, null);
            this._08._g9(PIC, Pic, this._F_E_);
            this._08._g9(SETCONDITION, SetCondition, null);
            this._08._g9(TELEPORT, Teleport, null);
            this._08._g9(USEPORTAL, UsePotal, null);
            ...
            this._08._g9(GROUNDDAMAGE, GroundDamage, null);
            this._08._g9(PLAYERHIT, PlayerHit, null);
            this._08._g9(ENEMYHIT, EnemyHit, null);
            this._08._g9(AOEACK, _bG_, null);
            this._08._g9(SHOOTACK, _0I_8, null);
            this._08._g9(OTHERHIT, OtherHit, null);
            this._08._g9(SQUAREHIT, SquareHit, null);
            this._08._g9(GOTOACK, GotoAck, null);
            ...
            this._08._g9(CHOOSENAME, ChooseName, null);
            this._08._g9(NAMERESULT, _0D_q, this._0D_s);
            this._08._g9(CREATEGUILD, CreateGuild, null);
            this._08._g9(_0F_w, _ic, this._Z_g);
            this._08._g9(GUILDREMOVE, GuildRemove, null);
            this._08._g9(GUILDINVITE, GuildInvite, null);
            this._08._g9(ALLYSHOOT, _I_o, this._P_F_);
            this._08._g9(_0_k, _C_3, this._0K_7);
            this._08._g9(REQUESTTRADE, RequestTrade, null);
            this._08._g9(TRADEREQUESTED, _Y_G_, this._G_r);
            this._08._g9(TRADESTART, _S_M_, this._47);
            this._08._g9(CHANGETRADE, ChangeTrade, null);
            this._08._g9(TRADECHANGED, _Z_J_, this._0D_U_);
            this._08._g9(ACCEPTTRADE, AcceptTrade, null);
            this._08._g9(CANCELTRADE, CancelTrade, null);
            this._08._g9(TRADEDONE, _A_L_, this._2d);
            this._08._g9(TRADEACCEPTED, _qe, this._087);
            this._08._g9(CLIENTSTAT, _0F_u, this._oA_);
            this._08._g9(CHECKCREDITS, CheckCredits, null);
            this._08._g9(ESCAPE, Escape, null);
            this._08._g9(_02h, File, this._J_0);
            this._08._g9(INVITEDTOGUILD, _039, this._cS_);
            this._08._g9(JOINGUILD, JoinGuild, null);
            this._08._g9(CHANGEGUILDRANK, ChangeGuildRank, null);
        ...
        private function load():void{
            var _local1:Load = (this._08._Y_E_(LOAD) as Load);
            _local1.charId_ = this.charId_;
            this._08._hb(_local1);
        }
        public function playerShoot(_arg1:int, _arg2:Projectile):void{
            var _local3:PlayerShoot = (this._08._Y_E_(PLAYERSHOOT) as PlayerShoot);
            _local3.time_ = _arg1;
        ...
        public function otherHit(_arg1:int, _arg2:int, _arg3:int, _arg4:int):void{
            var _local5:OtherHit = (this._08._Y_E_(OTHERHIT) as OtherHit);
            _local5.time_ = _arg1;
            _local5.bulletId_ = _arg2;
        ...
        public function squareHit(_arg1:int, _arg2:int, _arg3:int):void{
            var _local4:SquareHit = (this._08._Y_E_(SQUAREHIT) as SquareHit);
            _local4.time_ = _arg1;
        ...
        public function groundDamage(_arg1:int, _arg2:Number, _arg3:Number):void{
            var _local4:GroundDamage = (this._08._Y_E_(GROUNDDAMAGE) as GroundDamage);
            _local4.time_ = _arg1;
            _local4.position_.x_ = _arg2;
            _local4.position_.y_ = _arg3;
            this._08._hb(_local4);
        ...
        public function _C_k(_arg1:String):void{
            var _local2:PlayerText = (this._08._Y_E_(PLAYERTEXT) as PlayerText);
            _local2.text_ = _arg1;
            this._08._hb(_local2);
        }
        public function _P_a(_arg1:int, _arg2:Number, _arg3:Number, _arg4:int, _arg5:int, _arg6:int, _arg7:int, _arg8:int, _arg9:int):void{
            var _local10:InvSwap = (this._08._Y_E_(INVSWAP) as InvSwap);
        ...
        public function _8q(_arg1:int, _arg2:int, _arg3:int):void{
            var _local4:InvDrop = (this._08._Y_E_(INVDROP) as InvDrop);
        ...
        public function useItem(_arg1:int, _arg2:int, _arg3:int, _arg4:int, _arg5:Number, _arg6:Number):void{
            var _local7:UseItem = (this._08._Y_E_(USEITEM) as UseItem);
            _local7.time_ = _arg1;
        ...
        public function _6v(_arg1:uint, _arg2:Number):void{
            var _local3:SetCondition = (this._08._Y_E_(SETCONDITION) as SetCondition);
        ...
        public function move(_arg1:int, _arg2:Player):void{
            ...
            var _local5:Move = (this._08._Y_E_(MOVE) as Move);
        ...
        public function usePortal(_arg1:int):void{
            var _local2:UsePotal = (this._08._Y_E_(USEPORTAL) as UsePotal);
            _local2.objectId_ = _arg1;
            this._08._hb(_local2);
        }
        ...
        public function _S__(_arg1:int):void{
            var _local2:GotoAck = (this._08._Y_E_(GOTOACK) as GotoAck);
            _local2.time_ = _arg1;
            this._08._hb(_local2);
        }
        ...
        public function _K_Q_(_arg1:String):void{
            var _local2:ChooseName = (this._08._Y_E_(CHOOSENAME) as ChooseName);
            _local2.name_ = _arg1;
            this._08._hb(_local2);
        }
        public function _S_W_(_arg1:String):void{
            var _local2:CreateGuild = (this._08._Y_E_(CREATEGUILD) as CreateGuild);
            _local2.name_ = _arg1;
            this._08._hb(_local2);
        }
        public function guildRemove(_arg1:String):void{
            var _local2:GuildRemove = (this._08._Y_E_(GUILDREMOVE) as GuildRemove);
            _local2.name_ = _arg1;
            this._08._hb(_local2);
        }
        public function _H_X_(_arg1:String):void{
            var _local2:GuildInvite = (this._08._Y_E_(GUILDINVITE) as GuildInvite);
            _local2.name_ = _arg1;
            this._08._hb(_local2);
        }
        public function requestTrade(_arg1:String):void{
            var _local2:RequestTrade = (this._08._Y_E_(REQUESTTRADE) as RequestTrade);
            _local2.name_ = _arg1;
            this._08._hb(_local2);
        }
        public function _rQ_(_arg1:Vector.<Boolean>):void{
            var _local2:ChangeTrade = (this._08._Y_E_(CHANGETRADE) as ChangeTrade);
            _local2.offer_ = _arg1;
            this._08._hb(_local2);
        }
        public function _E_i(_arg1:Vector.<Boolean>, _arg2:Vector.<Boolean>):void{
            var _local3:AcceptTrade = (this._08._Y_E_(ACCEPTTRADE) as AcceptTrade);
        ...
        public function sendVisibullet(_damage:int, _enemyId:int, _bulletId:int, _armorPiercing:Boolean):void {
            var projI:Visibullet = this._08._Y_E_(VISIBULLET) as Visibullet;
            projI.damage_ = _damage;
            projI.enemyId_ = _enemyId;
            projI.bulletId_ = _bulletId;
            this._08._hb(projI);
        }
        ...
        public function joinGuild(_arg1:String):void{
            var _local2:JoinGuild = (this._08._Y_E_(JOINGUILD) as JoinGuild);
            _local2.guildName_ = _arg1;
            this._08._hb(_local2);
        }

        public function _k8(_arg1:String, _arg2:int):void{
            var _local3:ChangeGuildRank = (this._08._Y_E_(CHANGEGUILDRANK) as ChangeGuildRank);
            _local3.name_ = _arg1;
