...
//com.company.assembleegameclient.game_.map.Square
...
package com.company.assembleegameclient.game_.map{
    ...
    import com.company.assembleegameclient.network.engine3d.TextureMatrix;
    import flash.display.IGraphicsData;
    import com.company.assembleegameclient.network.util._V_m;
    ...
    public class Square {
        ...
        public function draw(_arg1:Vector.<IGraphicsData>, _arg2:MapView, _arg3:int):void{
        ...
        public function _D_r(_arg1:Vector.<IGraphicsData>, _arg2:MapView, _arg3:int):void{
        ...
        private function _08U_():void{
            ...
            {
                this.faces_.push(new Animation(this.texture_, this._02I_, this.props_._zT_, this.props_._zT_, this.props_.animate_.type_, this.props_.animate_.dx_, this.props_.animate_.dy_));
                _local1 = _V_m.redraw(this, false);
                if (_local1 != null)
                {
                    this.faces_.push(new Animation(_local1, this._02I_, 0, 0, _M_X_._0I_7, 0, 0));
                };
            } else
            {
                ...
                this.faces_.push(new Animation((((_local1)!=null) ? _local1 : this.texture_), this._02I_, _local2, _local3, _M_X_._0I_7, 0, 0));
            };
            ...
            if (this.props_._S_7)
            {
                ...
                this._0_C_ = new Animation(_local4, _local5, 0, 0, this.props_._003.type_, this.props_._003.dx_, this.props_._003.dy_);
            };
        }
