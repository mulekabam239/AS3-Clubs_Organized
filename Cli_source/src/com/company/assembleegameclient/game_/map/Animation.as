...
//com.company.assembleegameclient.game_.map.Animation

package com.company.assembleegameclient.game_.map{
    import com.company.assembleegameclient.network.engine3d.Face3D;
    ...
    public class Animation {
        ...
        public function Animation(_arg1:BitmapData, _arg2:Vector.<Number>, _arg3:Number, _arg4:Number, _arg5:int, _arg6:Number, _arg7:Number){
        ...
        public function draw(_arg1:Vector.<IGraphicsData>, _arg2:MapView, _arg3:int):Boolean{
            var _local4:Number;
            var _local5:Number;
            if (this.animate_ != _M_X_._0I_7)
            {
