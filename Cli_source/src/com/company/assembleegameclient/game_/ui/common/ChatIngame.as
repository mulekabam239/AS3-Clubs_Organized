...
//com.company.assembleegameclient.game_.ui.ChatIngame

package com.company.assembleegameclient.game_.ui.common{
import com.company.assembleegameclient.game_.ui.common.ChatColours;
...
import flash.display.Sprite;
    ...
    public class ChatIngame {

        private static var _0I_T_:ChatColours = new ChatColours();
        ...
        public function ChatIngame(_arg1:int, _arg2:String, _arg3:int, _arg4:int, _arg5:String, _arg6:Boolean, _arg7:String){
            this.time_ = _arg1;
            this.name_ = _arg2;
            if (_arg4 >= 0)
            {
